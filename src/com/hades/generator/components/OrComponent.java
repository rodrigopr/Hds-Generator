...
import com.hades.generator.ComponentManager;
import com.hades.generator.ConnectionManager;
import com.hades.generator.HdsComponent;
import com.hades.generator.HdsPort;
import com.hades.generator.ports.*;

public class OrComponent extends HdsComponent {

	protected int usedConnections = 0;
	protected OrComponent sister = null;
	...
	public String print() {
		if(usedConnections == 4)
			return String.format("hades.models.gates.Or4 %s %d %d @N 1001 1.0E-8", name, X, Y);
		else if(usedConnections == 3)
			return String.format("hades.models.gates.Or3 %s %d %d @N 1001 1.0E-8", name, X, Y);
		else
			return String.format("hades.models.gates.Or2 %s %d %d @N 1001 1.0E-8", name, X, Y);
	}
	...
	private void split() throws InstantiationException, IllegalAccessException {
		sister = (OrComponent) ComponentManager.getInstance().createComponent(OrComponent.class, this.name + "s");	
